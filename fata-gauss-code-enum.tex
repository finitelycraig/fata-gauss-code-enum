...
\begin{frame}{Equivelent knots and reidemeister Moves}
	...
	\end{itemize}
	\item[] \includegraphics<3->[width=.30\textwidth]{R_1.jpg}
	\item[] \includegraphics<4->[width=.30\textwidth]{R_2.jpg}
	\item[] \includegraphics<5->[width=.30\textwidth]{R_3.jpg}
	}
\end{frame}
...
\begin{frame}{A candidate for a canonical Gauss code}
    ...
    \only<7-9>{
    	\begin{itemize}
    		...
    		\item<9> But such a lexicographically minium representation of the unsigned Gauss code is necissary in the input of an algorithm which follows.
    	\end{itemize}
    }
...
\begin{frame}{Virtual knots}
	\begin{columns}
		...
		\only<3>{
			\begin{itemize}
				\item[] \includegraphics<2->[width=.45\textwidth]{virtual_1-2.jpg}
			\end{itemize}
		}
		\end{column}
	\end{columns}
