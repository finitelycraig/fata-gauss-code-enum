...
\begin{frame}{Representing knots with Gauss codes}
    \begin{columns}
        \begin{column}{0.65\textwidth}
            ...
            \begin{center}
	            \only<8->{${-1}$}
	            \only<8-9>{{\color{white}, $4$}}
	            \only<9->{, $4$}
	            \only<8-10>{{\color{white}, ${-3}$}}
	            \only<10->{, ${-3}$}
	            \only<8-11>{{\color{white}, $1$}}
	            \only<11->{, $1$}
	            \only<8-12>{{\color{white}, ${-2}$}}
	            \only<12->{, ${-2}$}
	            \only<8-13>{{\color{white}, $3$}}
	            \only<13->{, $3$}
	            \only<8-14>{{\color{white}, ${-4}$}}
	            \only<14->{, ${-4}$}
	            \only<8-15>{{\color{white}, $2$}}
	            \only<15->{, $2$}
	        \end{center}
        \end{column}
